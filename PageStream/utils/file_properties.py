# PageStream/utils/file_properties.py
...
from PageStream.server.exceptions import FileNotFound
...
def get_file_category(file_name: str) -> Optional[str]:
    ...
    for category, extensions in ALLOWED_CATEGORIES.items():
...
def get_fname(msg: Message) -> str:
    ...
    if not fname:
        ...
        fname = f"PageStream File To Link_{timestamp}.{ext}"
