...
from PageStream import __version__
from PageStream.bot import StreamBot
from PageStream.bot.clients import cleanup_clients, initialize_clients
from PageStream.server import web_server
from PageStream.utils.commands import set_commands
from PageStream.utils.database import db
from PageStream.utils.keepalive import ping_server
from PageStream.utils.canonical_files import drain_background_touch_tasks
...
║                                                                   ║
║    ___                 ___ _                                      ║
║   / _ \__ _ __ _ ___  / __\ |_ _ __ ___  __ _ _ __ ___            ║
...
async def import_plugins():
    ...
    for file_path in plugins:
        try:
            ...
            import_path = f"PageStream.bot.plugins.{plugin_name}"
