...
MSG_WELCOME = (
    ...
    "You can view PDFs, EPubs, and Comics (CBR/CBZ) directly online using our premium built-in reader!\n\n"
    "⚡ **Quick Start Guide:**\n"
    "• **Private:** Send or forward any file here, and I'll generate the links immediately.\n"
    "• **Groups:** Reply to a file with `/link` to generate links in public chats.\n\n"
    "👉 Click **Get Help** below to view all commands and features!"
)

MSG_HELP = (
    "📘 **Thunder Bot - User & Admin Guide** 📖\n\n"
    ...
    "• **Groups:** Reply to any file with `/link`.\n"
    "• **Batch Mode (Groups):** Reply to the first file with `/link <number>` (e.g., `/link 5` to process up to {max_files} files in one go).\n\n"
    ...
    "• `/dc` - Inspect Telegram Data Center (DC) info for files or users.\n\n"
    "💡 **Tips:**\n"
